...
class DashboardListMenuButtonContainer extends React.Component<IDashboardListMenuButtonProps, any> {
    ...
    render() {
        return <SyncContainer sync={this.props.dashboardList.sync} onRenderSync={this._onRenderSync} onRenderDone={this._onRenderDone} />;
    }
}

class DashboardListMenuApplet extends React.Component<any, any> {
    render() {
        return <DashboardListMenuButton dashboardList={DashboardListStore} />;
    }
}

export { DashboardListMenuButtonContainer as default, DashboardListMenuButtonContainer, DashboardListMenuButton }