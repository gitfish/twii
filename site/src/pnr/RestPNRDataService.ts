...
//Responses
interface IPNRServiceExtendedResponse {
    errors?: any;
    totalrecords?: number;
}


interface IDSPNRTicketPaymentResponse extends IPNRServiceExtendedResponse {
    getPnrTicketPaymentDetails?: IDSPNRTicketPaymentResults;
}

interface IDSPNRTicketResponse extends IPNRServiceExtendedResponse {
    getPnrTicketingDetails?: IDSPNRTicketResults;
}

interface IDSPNRCheckinBagsInfoResponse extends IPNRServiceExtendedResponse {
    getPNRCheckinBagsInfo?: IDSPNRCheckinBagsInfoResults;
}

interface IDSPersonHistoricalPNRResponse extends IPNRServiceExtendedResponse {
    getPersonHistoricalPNR?: IDSPersonHistoricalPNRResults;
}

interface IDSPNRAirlineArrangementResponse extends IPNRServiceExtendedResponse {
    getPNRAirlineArrangement?: IDSPNRAirlineArrangementResults;
}

interface IDSIATTravellerHistoricalPNRResponse extends IPNRServiceExtendedResponse {
    getIATTravellerHistoricalPNR?: IDSIATTravellerHistoricalPNRResults;
}

interface IDSPNRActiveItineraryResponse extends IPNRServiceExtendedResponse {
    getPnrActiveItenaryDetails?: IDSPNRActiveItineraryResults;
}

interface IDSPNRCheckInAndBoardingResponse extends IPNRServiceExtendedResponse {
    getPnrCheckInAndBoardingDetails?: IDSPNRCheckInAndBoardingResults;
}

interface IDSPNRPushHistoryResponse extends IPNRServiceExtendedResponse {
    getPNRPushHistory?: IDSPNRPushHistoryResults;
}

interface IDSPNRTravelSummaryResponse extends IPNRServiceExtendedResponse {
    getPnrTravelSummaryDetails?: IDSPNRTravelSummaryResults;
}

interface IDSPNRTravelStayResponse extends IPNRServiceExtendedResponse {
    getPnrTravelStayDetails?: IDSPNRTravelStayResults;
}

interface IDSPNRRemarkFreeTextResponse extends IPNRServiceExtendedResponse {
    getPNRRemarksFreeText?: IDSPNRRemarkFreeTextResults;
}

interface IDSPNROtherServiceInfoResponse extends IPNRServiceExtendedResponse {
    getPNROtherServiceInformation?: IDSPNROtherServiceInfoResults;
}

interface IDSPNRProfileDetailsAssociatedWithPnrResponse extends IPNRServiceExtendedResponse {
    getProfileDetailsAssociatedWithPnr?: IDSPNRProfileDetailsAssociatedWithPnrResults;
}

interface IDSPNRSpecialServiceRequestResponse extends IPNRServiceExtendedResponse {
    getPNRSpecialServiceRequest?: IDSPNRSpecialServiceRequestResults;
}

interface IDSPNRTravelAgentResponse extends IPNRServiceExtendedResponse {
    getPnrTravelAgentDetails?: IDSPNRTravelAgentResults;
}

interface IDSLinkedOrSplitPnrResponse extends IPNRServiceExtendedResponse {
    getLinkedOrSplitPnrDetails?: IDSLinkedOrSplitPnrResults;
}

interface IDSPNRContactDetailsResponse extends IPNRServiceExtendedResponse {
    getPnrContactsDetails?: IDSPNRContactDetailsResults;
}

interface IDSPNRHistoryResponse extends IPNRServiceExtendedResponse {
...
//Rest service impl
//class DataServiceRestPNRService  extends AbstractRestDataService implements IPNRDataService {
class DataServiceRestPNRService implements IPNRDataService {
