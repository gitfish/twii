...
class ChainedStorageService implements IStorageService {
    _chain : IStorageService[] = [];
    ...
    _getItemInternal(key : string, index : number) : Promise<any> {
...
export { ChainedStorageService as default, ChainedStorageService }