    ...
    render() {
        return (
            <ListingStoreFrontSection
                title="Featured">
                <SyncContainer sync={this.props.storeFront.sync} onRenderDone={this._onRenderDone} syncLabel="Loading Featured Listings..." />
            </ListingStoreFrontSection>
        );
    }
}
...
class ListingStoreFrontMostPopularSection extends React.Component<IListingStoreFrontProps, any> {
    ...
    render() {
        return (
            <ListingStoreFrontSection
                title="Most Popular">
                <SyncContainer sync={this.props.storeFront.sync} onRenderDone={this._onRenderDone} syncLabel="Loading Most Popular Listings..." />
            </ListingStoreFrontSection>
        );
    }
}
...
class ListingStoreFrontRecommendedSection extends React.Component<IListingStoreFrontProps, any> {
    ...
    render() {
        return (
            <ListingStoreFrontSection
                title="Recommended">
                <SyncContainer sync={this.props.storeFront.sync} onRenderDone={this._onRenderDone} syncLabel="Loading Recommended Listings..." />
            </ListingStoreFrontSection>
        );
    }
}
...
class ListingStoreFrontRecentSection extends React.Component<IListingStoreFrontProps, any> {
    ...
    render() {
        return (
            <ListingStoreFrontSection
                title="Recent">
                <SyncContainer sync={this.props.storeFront.sync} onRenderDone={this._onRenderDone} syncLabel="Loading Recent Listings..." />
            </ListingStoreFrontSection>
        );
    }
}
...
class ListingStoreFrontSearchInput extends React.Component<IListingStoreFrontProps, any> {
    ...
    render() {
        return <SearchBox value={this.props.storeFront.searchText} onChange={this._onSearchChange} />
    }
}
        ...
        if(isNotBlank(this.props.storeFront.searchText)) {
            return (
                <ListingStoreFrontSection
                    ...
                    <SyncContainer sync={this.props.storeFront.searchSync} onRenderDone={this._onRenderDone} syncLabel="Searching Listings..." />
                </ListingStoreFrontSection>
            );
        }
        return null;
...
class ListingStoreFrontAdminCommandBar extends React.Component<IListingStoreFrontProps, any> {
    ...
    render() {
        ...
        farItems.push({
            ...
            disabled: this.props.storeFront.sync.syncing || this.props.storeFront.searchSync.syncing
        })
...
export { ListingStoreFrontContainer, ListingStoreFront }