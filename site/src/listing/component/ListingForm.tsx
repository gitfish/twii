...
import { IDetailsStyles } from "common/component/Details.styles";
...
class ListingFormContainer extends React.Component<IListingFormContainerProps, any> {
    private _onRenderDone = () => {
        return <ListingForm listing={this.props.listingHandle.value} onCancel={this.props.onCancel} onAfterSave={this.props.onAfterSave} />;
    }
    render() {
