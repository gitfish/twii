...
interface IStackStyles {
    ...
    actionIcon?: IStyle;
    addAction?: IStyle;
    addActionIcon?: IStyle;
    tab?: IStyle;
    tabIconContainer?: IStyle;
        ...
        tab: {
            ...
            selectors: {
                ...
                "&.active": {
                    ...
                    boxShadow: `3px 0px 3px -2px ${theme.palette.neutralTertiary}, -3px 0px 3px -2px ${theme.palette.neutralTertiary}`,
                    zIndex: 1,
                    selectors: {
                        ".close-action": {
                            visibility: "visible"
...
export { IStackStyles, getStyles, Defaults, defaultStyles }