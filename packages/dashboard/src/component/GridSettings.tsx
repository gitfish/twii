...
class GridCellMarginSlider extends React.Component<IGridCellSliderProps, any> {
    ...
    render() {
        return <Slider label={this.props.label} ariaLabel={`Grid Cell Margin ${this.props.grid.cellMargin}`} min={this.props.min || 0} max={this.props.max || 16} value={this.props.grid.cellMargin} onChange={this._onChange} />;
    }
}
...
class GridCellSizeSlider extends React.Component<IGridCellSliderProps, any> {
    ...
    render() {
        return <Slider label={this.props.label} ariaLabel={`Grid Cell Size ${this.props.grid.cellSize}`} min={this.props.min || 10} max={this.props.max || 160} value={this.props.grid.cellSize} onChange={this._onChange} />;
    }
}
