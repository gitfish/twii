...
describe("Split Test", () => {
    ...
    test("hsplit viewport test", () => {
        ...
        expect(leftPortal.left).toBe(left.x);
        expect(leftPortal.top).toBe(left.y);
        ...
        expect(rightPortal.left).toBe(right.x);
        expect(rightPortal.top).toBe(right.y);
    ...
    test("vsplit viewport test", () => {
        ...
        expect(topPortal.left).toBe(top.x);
        expect(topPortal.top).toBe(top.y);
        ...
        expect(bottomPortal.left).toBe(bottom.x);
        expect(bottomPortal.top).toBe(bottom.y);
